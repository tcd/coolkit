    ...
    module FromYard
      class Attribute
        ...
        def determine_if_read_only()
          ...
          if self.class_code_object.attributes[:instance][self.name][:write].nil?()
            self.is_read_only = true
          end
        end
        ...
        def determine_default_value()
          if (default = Lib::Util.find_tag(self.method_code_object, "default_value"))
            if self.ruby_type == "String"
              self.default_value = default.text
            elsif self.ruby_type == "Integer" || self.ruby_type == "Numeric"
              self.default_value = default.text.to_i()
            elsif self.ruby_type == "Boolean"
              self.default_value = default.text.downcase == "true"
            end
          end
        end
